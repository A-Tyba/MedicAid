        ...
        <div class="form-container">
            ...
            <form autocomplete="off" action="checkout-charge.php" method="POST">
                ...
                <div>
                    ...
                    <input type="text" name="c_name" value="example" required/>
                ...
                <div>
                    ...
                    <input type="text" name="address" value="example" required/>
                ...
                <div>
                    ...
                    <input type="number" id="ph" name="phone" pattern="\d{10}" maxlength="10" value="123456789" required/>
