...
check_retype_password();
   ...
   function check_password() {
      ...
      if (!(password.match(/[A-Z]/))) {
         ...
         $("#password_error_message").html("Password must contain at least 1 capital letter");
         ...
         $("#password_error_message").html("Password must contain at least 1 special character");
   ...
   $("button").click(function send_form_data(){
    ...
    event.preventDefault();
      ...
      var repass = $("#form_retype_password").val();
