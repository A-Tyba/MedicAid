...
$_SESSION['doctor_for_upload'] = $_GET['q'];
...
<body>
  ...
  <div class="container fixed-center">
      ...
      <div class="py-5 text-center">
        ...
        <p class="lead">Here you can upload your pictures to show your doctor, upload individual pictures in a sequence</p><br>
        ...
        <p class="lead">Let your doctor know about your current condition, please upload carefully, one by one</p>
...
//   var dir = "uploads/"+email;
  ...
  $("#img").attr("src","patient_pictures/"+email+"/"+image_name[0]); // updating prescription preview image on page
